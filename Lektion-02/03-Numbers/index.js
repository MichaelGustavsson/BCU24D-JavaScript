...
// Vi kan testa om ett tal är ett heltal...
...
console.log(Number.parseFloat('1256.789').toFixed(2));
...
// Räkna ut antalet timmar och antal minuter på en tidslängd...
let length = 210; //210 minuter...
let hours = Math.floor(210 / 60);
console.log('Hours', hours);
let minutes = 210 % 60;
console.log('Minutes', minutes);

// Beräkna ett slumptal...
let rnd = Math.random();
